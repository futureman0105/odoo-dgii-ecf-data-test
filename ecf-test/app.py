        ...
        if cell_value == search_text:
            ...
            while True:
                ...
                if value == "#e" :
                    value = ""             
                ET.SubElement(Pagina, 'PaginaNo').text = value
                __logger.info(f'PaginaNo : {value}')
                __logger.info(f'PaginaNo col_index : {col_index}')
                col_index += 1
...
def main():
    ...
    try:
        ...
        # xml_str = create_e_cf_34(5) # 4, 5
        # xml_str = create_e_cf_41(16) # 6, 16 
        # xml_str = create_e_cf_43(18) # 17, 18
        # xml_str = create_e_cf_44(20) # 19, 20
        # xml_str = create_e_cf_45(22) # 21, 22
        # xml_str = create_e_cf_46(24) # 23, 24
